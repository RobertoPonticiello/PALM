...
const Line = ({ text, delay, size, italic = false, weight = 600, perWord = 4 }: {
  text: string; delay: number; size: number; italic?: boolean; weight?: number; perWord?: number;
}) => {
  ...
  return (
    <div style={{
      ...
      fontSize: size, color: "#f5f1e6", lineHeight: 1.15, letterSpacing: -2, textAlign: "center",
    }}>
      {words.map((w, i) => {
...
export const SceneProblemBeat = () => (
  <AbsoluteFill style={{ alignItems: "center", justifyContent: "center", background: "#0a1f15" }}>
    <div style={{ padding: "0 80px" }}>
      <Line text="La storia di tuo figlio è ovunque." delay={10} size={68} />
      <div style={{ height: 60 }} />
      <Line text="E da nessuna parte." delay={70} size={88} italic weight={700} />
    </div>
  </AbsoluteFill>
);
